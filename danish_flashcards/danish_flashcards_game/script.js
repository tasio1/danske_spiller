...
const verbs = [
    ...
    { infinitive: 'krybe', present: 'krøber', past: 'krøb', pastParticiple: 'krøbet', translation: 'to crawl', example: 'Babyen krøber på gulvet.', exampleEn: 'The baby crawls on the floor.' },
    ...
    { infinitive: 'bør', present: 'bør', past: 'burde', pastParticiple: 'burdet', translation: 'to ought to/should', example: 'Du bør spise flere grøntsager.', exampleEn: 'You should eat more vegetables.' },
    { infinitive: 'tør', present: 'tør', past: 'turde', pastParticiple: 'turdet', translation: 'to dare', example: 'Han tør ikke springe ud i vandet.', exampleEn: "He doesn't dare jump into the water." },
